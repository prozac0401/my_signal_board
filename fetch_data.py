...
def save(name: str, obj: pd.Series | pd.DataFrame) -> None:
    """Save object as CSV to data/ and print nice log."""
...
# --- M2 (first non‑empty series fallback) ------------------------------------
_m2_candidates = [
    ecos("101Y003", ITEM_CODE1="BBHS00"),
    ecos("060Y002"),
    ecos("LDT_MA001_A", ITM_ID="A"),
]
# take the first non‑empty series; if all empty, create an empty series to avoid crash
