...
| 구간 | 해석 | 시사점 |
|------|------|-------|
| **> 9 %**  <span style="color:#16a085">● 팽창</span> | 평균+0.5 σ↑ | **리스크-온** (주식·부동산 ↑) |
| **6-9 %** <span style="color:#2ecc71">● 완충</span> | 평균 부근 | 중립 · 추세 확인 |
| **3-6 %** <span style="color:#f39c12">● 둔화</span> | 평균-1 σ↑ | 경계 · 리밸런스 |
| **< 3 %** <span style="color:#e74c3c">● 수축</span> | 평균-1 σ↓ | **리스크-오프** (현금·단기채 ↑) |

**TIP**  
* M2 팽창 + 환율 ↓ + KODEX ↑ → 공격적 비중 확대  
* M2 수축 + Gold ↓ → 안전자산 축소
"""
